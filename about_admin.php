...
<table bgcolor="gray" width="99%" align="center" class="my-style-font2" valign="center" 
height="80" border="0" cellpadding="5" cellspacing="5">
<tr>
<td width="25%"></td>
	<td align="center" width="10%"><a href="home_admin.php" >Home</a></td>
	<td align="center" width="10%"><a href="myAccount.php">Profile</a></td>
	<td align="center" width="10%"><a href="help.php">Help</a></td>
	<td align="center" width="10%"><a href="about_admin.php">About</a></td>
...
<br><br>
<center>
	<p style="color: #8f8270">
	Grade report is a system that	allows the teacher to create, access, and updates
	<br> 
	class grades for students in his classes.
	<br>	
 	And the	students in	the	class are then able to check
 	<br>	
    their grades for all exams taken in that class.
</p>

<p style="color: #534542">
	The system created by FCIH students:
	<br>
	Osama Ahmed Aref
	<br>
	Ahmed Mohamed Gamal
